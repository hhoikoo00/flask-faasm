...
Adapted from: https://github.com/python/pyperformance/blob/main/pyperformance/data-files/benchmarks/bm_nbody/run_benchmark.py
"""
...
def bench_nbody(loops=25, reference=DEFAULT_REFERENCE, iterations=DEFAULT_ITERATIONS):
    # Set up global state
