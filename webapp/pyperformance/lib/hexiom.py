...
Adapted from: https://github.com/python/pyperformance/blob/main/pyperformance/data-files/benchmarks/bm_hexiom/run_benchmark.py
"""
...
def bench_hexiom(loops=DEFAULT_LOOPS, level=DEFAULT_LEVEL):
