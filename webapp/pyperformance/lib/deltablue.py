...
Adapted from: https://github.com/python/pyperformance/blob/main/pyperformance/data-files/benchmarks/bm_deltablue/run_benchmark.py
"""
...
def bench_deltablue(n=100):
    global planner
    planner = Planner()

    chain_test(n, planner)
    projection_test(n, planner)
