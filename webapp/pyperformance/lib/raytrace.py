...
Adapted from: https://github.com/python/pyperformance/blob/main/pyperformance/data-files/benchmarks/bm_raytrace/run_benchmark.py
"""
...
def bench_raytrace(loops=25, width=DEFAULT_WIDTH, height=DEFAULT_HEIGHT):
